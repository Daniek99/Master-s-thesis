#This script computes and plots the active and inactive periods of each damper during each test.
#See the activation and deactivation conditions for reference.
...
# === Settings ===
THRESHOLD = 0.4    # Activation condition: Displacement larger than 0.4 mm
...
for i, col in enumerate(valid_disp_columns):
    ...
    lower_bound = target_val - THRESHOLD   #Deactivates if value is within 0.4 mm of end value for a period of time
